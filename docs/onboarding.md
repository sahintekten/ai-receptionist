...
5. Create GHL location for the business in the agency account
...
### V1 Tooling
- Onboarding seed script: takes a JSON config file and automates steps 2, 7, 8 (creates business record, adds integration configs, runs config validation). Manual steps (Retell agent, GHL location, Cal.com event types) remain manual in V1.
